...
POMODORO_TIME = 4000#1500000  # 25 minutes in milliseconds
SHORT_BREAK_TIME = 1000#300000  # 5 minutes in milliseconds
LONG_BREAK_TIME =3000# 900000  # 15 minutes in milliseconds
...
class PomodoroTimer(QWidget):
    ...
    def startCountDown(self):
        ...
        # TODO: disable start button and start the timer    done
        self.pomodoro_start_button.setEnabled(False)
        self.short_start_button.setEnabled(False)
    ...
    def stopCountDown(self):
        ...
        if self.timer.isActive():
            # TODO: stop the timer and enable start button  done
            
            self.pomodoro_start_button.setEnabled(True)
            self.short_start_button.setEnabled(True)
    ...
    def resetCountDown(self):
        ...
        if self.current_tab_selected == 0:  # Pomodoro tab
            ...
            self.long_break_lcd.display(reset_time)
            self.current_time_limit = self.long_break_limit

            pass

        # TODO: edit above if else statements to set reset_time correctly   done
    ...
    def updateTimer(self):
        ...
        if remaining_time == "00:00":
            ...
            # TODO: reduce current_time_limit by 1 second   done
            self.current_lcd.display(remaining_time) 
            print(self.current_time_limit)
    ...
    def tabsSwitched(self, index):
        ...
        # TODO: update current_tab_selected done
        self.stopCountDown()
    ...
    def convertTotalTime(self, time_in_milli):
        ...
        # TODO: edit below to correct conversion    done

        minutes = (time_in_milli) // (60*1000)
