...
class LoginUI(QWidget):
    ...
    def loginUserInterface(self):
        ...
        # TODO: Connect to self.clickLogin  done
        ...
        # TODO: Connect to self.displayPassword, check hint if you don't know how   done
        ...
        # TODO: Connect to self.createNewUser   done
    ...
    def clickLogin(self):
        ...
        if (username, password) in users.items():
            # TODO: show a information msg box to tell user that login successful   done
            ...
            # TODO: show a warning msg box to tell user that username or password incorrect done
            QMessageBox().warning(self, "Error Message",
                                      "The username or password is incorrect", QMessageBox.Close, QMessageBox.Close)
